                ...
                <div class="grid grid-rows-1 grid-cols-1 lg:grid-cols-5 gap-6">
                    ...
                    <ul class="lg:col-span-4 grid grid-rows-1 grid-cols-2 lg:grid-rows-2 lg:grid-cols-3 gap-6">
                        ...
                        <li
                            ...
                            <svg class="lock w-10 lg:w-12 aspect-square pointer-events-none text-yellow-500"
                                fill="currentcolor" viewBox="0 -960 960 960">
                                <path
                        ...
                        <li
                            ...
                            <svg class="lock w-10 lg:w-12 aspect-square pointer-events-none text-red-500"
                                fill="currentcolor" viewBox="0 -960 960 960">
                                <path
                        ...
                        <li
                            ...
                            <svg class="lock w-10 lg:w-12 aspect-square pointer-events-none text-teal-500"
                                fill="currentcolor" viewBox="0 -960 960 960">
                                <path
                        ...
                        <li
                            ...
                            <svg class="lock w-10 lg:w-12 aspect-square pointer-events-none text-violet-500"
                                fill="currentcolor" viewBox="0 -960 960 960">
                                <path
