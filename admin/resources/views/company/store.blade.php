...
@section('content')
    <form validate action="{{ route('actions.companies.store') }}" method="POST" enctype="multipart/form-data" class="w-full">
        @csrf
            ...
            <div class="p-6 bg-x-white rounded-x-thin shadow-x-core w-full flex flex-col gap-6">
                <neo-tab-outlet name="outlet-1" class="grid grid-cols-1 grid-rows-1 gap-6">
                    <div class="flex flex-col gap-1">
                        ...
                        <neo-imagetransfer rules="required" errors='{"required": "{{ __('The logo field is required') }}"}'
                ...
                <neo-tab-outlet name="outlet-3" class="grid grid-cols-1 grid-rows-1 gap-6">
                    <div class="flex flex-col gap-1">
                        ...
                        <neo-textbox rules="required"
                            ...
                            value="{{ old('representative_first_name') }}"></neo-textbox>
                    </div>
                    <div class="flex flex-col gap-1">
                        <label class="text-x-black font-x-thin text-base">
                        ...
                        <neo-textbox rules="required"
                            ...
                            value="{{ old('representative_last_name') }}"></neo-textbox>
                    </div>
                    <div class="flex flex-col gap-1">
                        <label class="text-x-black font-x-thin text-base">
                        ...
                        <neo-textbox rules="required|email"
                            ...
                            name="representative_email" value="{{ old('representative_email') }}"></neo-textbox>
                    </div>
                    <div class="flex flex-col gap-1">
                        <label class="text-x-black font-x-thin text-base">
                        ...
                        <neo-textbox rules="required|phone"
                            ...
                            name="representative_phone" value="{{ old('representative_phone') }}"></neo-textbox>
                    </div>
                </neo-tab-outlet>
