<neo-sidebar id="sidebar">
    ...
    <ul class="nav-colors w-full flex flex-col flex-1 mt-6 lg:mt-0">
        ...
        <li class="w-full mib-w-[240px] overflow-hidden">
            <a href="{{ route('views.companies.index') }}"
                class="w-full flex flex-wrap gap-2 px-3 py-2 text-start items-center outline-none lg:rounded-e-full hover:text-x-white hover:bg-x-acent focus:text-x-white focus:bg-x-acent focus-within:text-x-white focus-within:bg-x-acent {{ Core::matchRoute('companies') ? 'bg-x-prime text-x-white' : 'text-x-black' }}">
                <svg class="block w-6 h-6 pointer-events-none" fill="currentcolor" viewBox="0 -960 960 960">
                    <path
                ...
                <span class="block flex-1 text-base">{{ __('Companies') }}</span>
            </a>
        </li>
        <li class="my-1.5"></li>
        <li class="w-full mib-w-[240px] overflow-hidden">
