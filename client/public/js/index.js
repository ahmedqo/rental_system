...
function bgdate (row) {
    if(typeof row.reservation === "object") row = row.reservation;
...
function searchable (field, route, callback, opts) {
...
function TableVisualizer (dataVisualizer, callback, routes, rowClick, colClick) {
    ...
    Links.innerHTML = `<neo-tooltip id="prev" slot="end"><a class="flex w-8 h-8 items-center justify-center text-x-black outline-none rounded-x-thin bg-x-shade hover:bg-x-light focus:bg-x-light focus-within:bg-x-light"><svg class="block w-6 h-6 pointer-events-none" fill="currentcolor" viewBox="0 -960 960 960"><path d="M452-219 190-481l262-262 64 64-199 198 199 197-64 65Zm257 0L447-481l262-262 63 64-198 198 198 197-63 65Z" /></svg></a></neo-tooltip><neo-tooltip id="next" slot="end"><a class="flex w-8 h-8 items-center justify-center text-x-black outline-none rounded-x-thin bg-x-shade hover:bg-x-light focus:bg-x-light focus-within:bg-x-light"><svg class="block w-6 h-6 pointer-events-none" fill="currentcolor" viewBox="0 -960 960 960"><path d="M388-481 190-679l64-64 262 262-262 262-64-65 198-197Zm257 0L447-679l63-64 262 262-262 262-63-65 198-197Z" /></svg></a></neo-tooltip>`;
