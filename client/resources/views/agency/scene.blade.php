...
@section('content')
    <div class="w-full items-start grid grid-rows-1 grid-cols-1 gap-6">
        ...
        <ul class="container mx-auto grid gap-6 grid-cols-2 grid-rows-1 lg:grid-cols-12 lg:grid-rows-6">
            ...
            <li
                class="lg:col-span-3 p-4 gap-4 flex lg:hidden flex-col flex-wrap items-center lg:flex-row relative bg-x-white rounded-x-thin shadow-x-core">
                <div
                    class="loader w-full h-full rounded-x-thin bg-x-white absolute inset-0 flex items-center justify-center">
                    <neo-loader></neo-loader>
                </div>
            ...
            <li
                class="flex flex-col col-span-2 lg:col-span-9 lg:row-span-5 relative bg-x-white rounded-x-thin shadow-x-core">
                <div
            ...
            <li
                class="lg:col-span-3 p-4 gap-4 hidden lg:flex flex-col flex-wrap items-center lg:flex-row relative bg-x-white rounded-x-thin shadow-x-core">
                <div
                    class="loader w-full h-full rounded-x-thin bg-x-white absolute inset-0 flex items-center justify-center">
                    <neo-loader></neo-loader>
                </div>
